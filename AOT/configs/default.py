...
class DefaultEngineConfig():
    def __init__(self, exp_name='default', model='AOTT'):
        ...
        self.TEST_CKPT_PATH = '/mnt/Models/rvos/aot/result/SwinL_AOTL/save_step_90000.pth'
        # self.TEST_CKPT_PATH = './pretrain_models/SwinB_AOTL_PRE_YTB_DAV.pth'
    ...
    def init_dir(self):
        ...
        # self.DIR_IMAGE = '/mnt/Data/Competition/youtube-VOS-new/2019/image/'
        # self.DIR_YTB_POST_EVAL = '/mnt/Models/rvos/postprocess/ensemble/models/result/key_frame_swin_L_642/'
        # self.PICKED_KEY_FRAMES_ID = self.DIR_YTB_POST_EVAL + '/key_frame_swin_L_642.json'
        # self.TEST_PHRASE = 'valid'
